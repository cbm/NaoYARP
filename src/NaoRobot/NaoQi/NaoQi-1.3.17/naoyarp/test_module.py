...
# Put here IP and Port of a broker containg module        
IP="127.0.0.1"
PORT=9559
...
#________________________________
def main():
	print '        START TESTING module MODULE'
	try:
		module_Proxy = ALProxy("module",IP,PORT)
	except Exception,e:
		print "Error when creating module  proxy:"
		print str(e)
		return(1)
	#________________________________
	...
	try:
		ret = module_Proxy.DummyFunction( "hello, world", inParam )
	except Exception,e:
